...
export class LAppLive2DManager
{
    ...
    public onTap(x: number, y: number): void
    {
        ...
        for(let i: number = 0; i < this._models.getSize(); i++)
        {
            ...
            if(this._models.at(i).hitTest(LAppDefine.HitAreaNameBody, x, y))
            {
                ...
                this._models.at(i).startMotion(LAppDefine.MotionGroupTapBody, 0, LAppDefine.PriorityNormal);
            }
            else if(this._models.at(i).hitTest(LAppDefine.HitAreaNameHead, x, y))
            {
                ...
                this._models.at(i).startMotion(LAppDefine.MotionGroupTapHead, 0, LAppDefine.PriorityNormal);
            }
            // ここから追加
    ...
    public onUpdate(): void
    {
        ...
        projection.scale(1 * 2, width / height * 2);
